...
int ball_speedX(int ball_speed_x, int ballX, int ballY, int lprX, int rprX,
                int lprY, int rprY) {
  if (((ballX == lprX + 1) &&
       ((ballY == lprY) || (ballY == lprY + 1) || (ballY == lprY + 2))) ||
      ((ballX == rprX - 2) &&
       ((ballY == rprY) || (ballY == rprY + 1) || (ballY == rprY + 2)))) {
...
int main() {
  ...
  while (1) {
    ...
    ball_speed_x =
        ball_speedX(ball_speed_x, ballX, ballY, lprX, rprX, lprY, rprY);
    clear();
    render(rprX, rprY, lprX, lprY, ballY, ballX);
